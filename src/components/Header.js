...
class Header extends React.Component {
  render() {
    return (
       <header>
          <ul id="slide-out" className="aqua-gradient side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
            <li>
          ...
          <nav className="navbar blue-gradient fixed-top navbar-toggleable-md navbar-expand-lg  scrolling-navbar double-nav">
